...
/**
 * Gestionnaire des mime/type HTTP
 * Date : Fevrier 2015
 * @author Rija ZAFIAMY
 */
public class ContentType{

    public String getTypeMime(String key){

        if(Mimelist.containsKey(key)){
            return Mimelist.get(key);
        }
        return null;
    }

    private static final HashMap<String,String> Mimelist = new HashMap<String,String>(){
